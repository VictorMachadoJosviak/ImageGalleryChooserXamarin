...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "ImageGalleryChooser.Droid.dll" comes first in this list. */
		"ImageGalleryChooser.Droid.dll",
		"FFImageLoading.dll",
